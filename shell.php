...
<div class="loader" style="opacity: 0.5;">
  ...
  <p class="loader-text" style="margin-top: 70px;color:white;">Connecting</p>
</div>
...
<html>
	...
	<body style="background-color: black;font-family:'Palanquin', sans-serif;">

	<div id="organized_chaos-header" class="organized_chaos-header" style="display: none;position: absolute;">
		<canvas id="organized_chaos-canvas"></canvas>
	</div>
		<input type="hidden" id="connected" class="connected">
		<div class="history">
			
		</div>
		<div class="certifier">
			<div class="input" style="display: none;margin-top: 0;">
				<?php 
					echo '<font class="user" color="green">Remote Terminal:</font><font color="#84b3ff">~ $ </font> <input class="shell" style="background: transparent;border: 0px;width: 50%;color: white;" type="text" name="command">';
				?>
			</div>
		</div>
	</body>
...
/* tästä alkaa kolmannen osapuolen scriptit. 
terminalin tausta effektit ja lataus effekti.
*/
...
(function() {
    ...
    function initHeader() {
        ...
        largeHeader = document.getElementById('organized_chaos-header');
        largeHeader.style.height = height+'px';

        canvas = document.getElementById('organized_chaos-canvas');
        canvas.width = width;
...
/* tähän loppuu kolmannen osapuolen */
</script>
